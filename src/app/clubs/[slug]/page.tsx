    ...
    <>
      ...
      <main className="min-h-screen bg-black text-white">
        ...
        <section className="py-16 bg-black">
          <div className="container mx-auto px-6">
            <div className="max-w-5xl mx-auto">
              <SectionTitle title="Our Team" color={club.color || 'from-purple-600 to-indigo-600'} />
              
              <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-6">
                {club.team.map((member) => (
                  <div key={member.id} className="bg-gray-900/50 backdrop-blur-sm rounded-xl p-6 border border-gray-800 flex flex-col">
                    <div className={`w-16 h-16 mb-4 rounded-xl bg-gradient-to-r ${club.color} flex items-center justify-center`}>
              ...
              <div className="bg-gray-900/80 backdrop-blur-md rounded-xl border border-gray-800 p-8">
                <form className="space-y-6">
                  ...
                  <div>
                    <button 
                      type="submit" 
                      className={`w-full py-3 px-6 rounded-lg bg-gradient-to-r ${club.color} text-white font-medium`}
                    >
                      Submit Application
                    </button>
                  </div>
