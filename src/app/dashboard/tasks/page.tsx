          ...
          <TaskForm
            task={
              editingTask
                ? {
                    ...editingTask,
                    assignedTo: editingTask.assignedTo._id, // convert object → string
                    status:
                      editingTask.status === "verified"
                        ? "completed" // fallback/mapping
                        : editingTask.status,
                  }
                : null
            }
                        ...
                        <div className="flex flex-wrap items-center gap-4">
                          <div>
                            ...
                            <select
                              ...
                              onChange={(e) =>
                                setTaskViewFilter(e.target.value)
                              }
            ...
            {isMember && (
              <div className="space-y-6">
                <div className="bg-gradient-to-br from-gray-900 to-gray-800 rounded-lg shadow-lg border border-gray-700 overflow-hidden p-6">
                  <div className="mb-6">
                    <h2
                      className={`text-xl font-semibold bg-gradient-to-r ${creditGradient} bg-clip-text text-transparent mb-4 flex items-center`}
                    >
                      <svg
                        xmlns="http://www.w3.org/2000/svg"
                        className={`h-5 w-5 mr-2 text-${
                          creditGradient.split("-")[1]
                        }-400`}
                        viewBox="0 0 20 20"
                        fill="currentColor"
                      >
                    ...
                    <div
                      className={`bg-gray-800/50 rounded-lg p-6 border border-${
                        creditGradient.split("-")[1]
                      }-900/30`}
                    >
                      <div className="flex flex-col md:flex-row justify-between items-center">
                        ...
                        <div className="mb-4 md:mb-0">
                          ...
                          <span
                            className={`text-lg font-semibold bg-gradient-to-r ${creditGradient} bg-clip-text text-transparent`}
                          >
                            {creditLevel}
                          </span>
                        </div>
