            ...
            <div className="bg-gray-800 p-6 rounded-lg shadow-lg">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                {session?.user?.role === 'admin' && (
                  <Link href="/dashboard/certificates/verify" className={`flex items-center text-sm font-medium px-2 py-1.5 rounded hover:bg-gray-700 ${pathname.startsWith('/dashboard/certificates/verify') ? 'bg-gray-700 text-white' : 'text-gray-400'}`}>
