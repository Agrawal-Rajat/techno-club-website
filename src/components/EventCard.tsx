...
const EventCard: React.FC<EventCardProps> = ({
  ...
  const clubColor =
    club && clubColorMap[club] ? clubColorMap[club] : clubColorMap["Default"];
    ...
    <div className="relative bg-gray-800 border border-gray-700 rounded-xl overflow-hidden shadow-lg transition-all duration-300 hover:shadow-xl hover:border-gray-600">
      ...
      <div className="p-5">
        {club && (
          <div className="mb-2">
            <span
              className={`${clubColor} text-white text-xs font-medium px-2.5 py-0.5 rounded`}
            >
              {club}
            </span>
          </div>
